...
- `cd Client && npm run tsc --noEmit` - Run Client type check to validate the feature works with zero regressions
- `cd Client && npm run build` - Run Client build to validate the feature works with zero regressions
