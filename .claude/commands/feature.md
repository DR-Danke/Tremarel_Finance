...
- `cd backend && uv run pytest` - Run backend tests to validate the feature works with zero regressions
- `cd frontend && npm run tsc --noEmit` - Run frontend type check to validate the feature works with zero regressions
