...
- Dedicated port ranges (server: 9100-9114, client: 9200-9214)
...
- Track essential workflow data:
  ...
  - `server_port`: Allocated server port (9100-9114)
  - `client_port`: Allocated client port (9200-9214)
...
# OPTION 1: Use API key (pay-as-you-go billing)
export ANTHROPIC_API_KEY="sk-ant-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
# OPTION 2: Use Claude Max subscription via OAuth (run 'claude login' first, leave ANTHROPIC_API_KEY unset)
...
- `server_port` and `client_port` allocated
...
- Server: 9100-9114 (15 ports)
- Client: 9200-9214 (15 ports)
...
**Example Allocations:**
```
ADW abc12345: Server 9107, Client 9207
ADW def67890: Server 9103, Client 9203
```
...
All slash commands now use **Opus 4.5** by default for maximum quality:
...
SLASH_COMMAND_MODEL_MAP = {
    ...
    # All commands use Opus 4.5 for both base and heavy model sets
}
```
...
3. Each slash command execution:
   ...
   - All commands now execute with Opus 4.5
